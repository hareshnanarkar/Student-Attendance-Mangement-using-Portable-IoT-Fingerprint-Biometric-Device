...
public class StudentGUI extends javax.swing.JPanel {
    ...
    public StudentGUI() {
        initComponents();
        jtxtStudId.setEnabled(false);
        jtxtStudId.setText("ID will be auto-generated");
        loadDepartmentList();
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jtxtStudId, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("Add, Remove or Update Student");
                ...
                Thread t=new Thread(new Runnable() {
                    ...
                    public void run() {
                        try{
                            ...
                            ObjectInputStream inputFromServer=new ObjectInputStream(sock.getInputStream());
                            ObjectOutputStream outputToServer=new ObjectOutputStream(sock.getOutputStream());
                            outputToServer.writeUTF("CREATE_STUDENT_REQUEST");
                            Student stud=new Student();
                        
                            stud.FirstName=jtxtFirstName.getText();
                            stud.MiddleName=jtxtMiddleName.getText();
                            stud.LastName=jtxtLastName.getText();
                            stud.EmailId=jtxtEmailId.getText();
                            stud.DeptId=arrDeptList.get(jcomboDepartment.getSelectedIndex()).DeptId;
                            stud.FingerTemplate=template;
                            
                            outputToServer.writeObject(stud);
                            outputToServer.flush();
                            String result=inputFromServer.readUTF();
                            System.out.println(result);
                            if(result.equals("CREATE_STUDENT_SUCCESSFUL"))
                            {
                                stud.StudId=inputFromServer.readInt();
